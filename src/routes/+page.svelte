...
<div class="relative home-page">
  <div class="relative isolate overflow-hidden gradient-container">
    <div class="absolute inset-x-0 top-[-50%] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-30%] gradient-bg" aria-hidden="true" style="will-change: transform; contain: content;">
      <div
