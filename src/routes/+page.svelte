...
<div class="relative">
  <div class="relative isolate overflow-hidden">
    <div class="absolute inset-x-0 top-[-50%] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-30%]" aria-hidden="true">
      <div
    ...
    <div class="absolute inset-x-0 bottom-[-25%] -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
      <div
